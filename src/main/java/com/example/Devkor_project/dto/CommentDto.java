...
public class CommentDto
{
    ...
    @Getter
    @Builder
    public static class NOT_UPDATED_StartUpdate
    {
        // CourseDto.Basic
    ...
    @Getter
    @Builder
    public static class UPDATED_StartUpdate
    {
        // CourseDto.Basic
        @NotNull(message = "course_id는 null일 수 없습니다.")
        @Schema(description = "course_id")
    ...
    @ToString
    @Builder
    public static class NOT_UPDATED_MyPage
    {
        @NotNull(message = "[comment_id] cannot be null.")
        @Schema(description = "comment_id")
        private Long comment_id;
    ...
    @ToString
    @Builder
    public static class UPDATED_MyPage
    {
        @NotNull(message = "[comment_id] cannot be null.")
        @Schema(description = "comment_id")
        private Long comment_id;
    ...
    public static CommentDto.NOT_UPDATED_StartUpdate NOT_UPDATED_entityToStartUpdate(
            Course course,
            CourseRating courseRating,
            com.example.Devkor_project.entity.Comment comment,
            CommentRating commentRating)
    {
        return NOT_UPDATED_StartUpdate.builder()
    ...
    public static CommentDto.UPDATED_StartUpdate UPDATED_entityToStartUpdate(
            Course course,
            CourseRating courseRating,
            com.example.Devkor_project.entity.Comment comment,
            CommentRating commentRating,
    ...
    {
        return UPDATED_StartUpdate.builder()
                .course_id(course.getCourse_id())
                .course_code(course.getCourse_code())
                .class_number(course.getClass_number())
                .graduate_school(course.getGraduate_school())
    ...
    public static CommentDto.NOT_UPDATED_MyPage NOT_UPDATED_entityToMyPage(
            com.example.Devkor_project.entity.Comment comment,
            Course course,
            CommentRating commentRating)
    {
        return NOT_UPDATED_MyPage.builder()
                .comment_id(comment.getComment_id())
                .course_id(course.getCourse_id())
                .course_code(course.getCourse_code())
                .class_number(course.getClass_number())
    ...
    public static CommentDto.UPDATED_MyPage UPDATED_entityToMyPage(
            com.example.Devkor_project.entity.Comment comment,
            Course course,
            CommentRating commentRating,
            List<TimeLocation> timeLocations
